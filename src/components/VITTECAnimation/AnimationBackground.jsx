  ...
  return (
    <div className={styles.background} aria-hidden="true">
      ...
      <svg className={styles.geometricLines} viewBox="0 0 1000 600" preserveAspectRatio="xMidYMid slice">
        <line x1="0" y1="150" x2="300" y2="50" stroke="rgba(14,165,233,0.06)" strokeWidth="1" />
        <line x1="700" y1="0" x2="1000" y2="200" stroke="rgba(6,182,212,0.05)" strokeWidth="1" />
        <line x1="0" y1="400" x2="200" y2="600" stroke="rgba(14,165,233,0.04)" strokeWidth="1" />
        <line x1="800" y1="600" x2="1000" y2="400" stroke="rgba(6,182,212,0.04)" strokeWidth="1" />
        {/* Corner brackets */}
        <path d="M 40 40 L 40 80 M 40 40 L 80 40" stroke="rgba(14,165,233,0.15)" strokeWidth="1.5" fill="none" />
        <path d="M 960 40 L 960 80 M 960 40 L 920 40" stroke="rgba(14,165,233,0.15)" strokeWidth="1.5" fill="none" />
        <path d="M 40 560 L 40 520 M 40 560 L 80 560" stroke="rgba(14,165,233,0.15)" strokeWidth="1.5" fill="none" />
        <path d="M 960 560 L 960 520 M 960 560 L 920 560" stroke="rgba(14,165,233,0.15)" strokeWidth="1.5" fill="none" />
        {/* Center ring */}
        <circle cx="500" cy="300" r="280" stroke="rgba(14,165,233,0.03)" strokeWidth="1" fill="none" />
        <circle cx="500" cy="300" r="200" stroke="rgba(6,182,212,0.04)" strokeWidth="0.5" fill="none" />
      </svg>
